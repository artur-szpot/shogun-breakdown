...
from constants import MAP_SELECTION, DECK, POTIONS, SHOP_COMPONENT, MAP_SAVE
...
class Snapshot:
    ...
    def from_file(filename: str, first: bool = False):
        ...
        try:
            ...
            if first:
                map_history = raw_data[MAP_SAVE][SHOP_COMPONENT]
        ...
        if first:
            retval.history = History(retval, map_history)
        return retval
